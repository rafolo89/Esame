...
<br />
      ...
      <div class="mainbar" ><!--Pannello della funzionalità principale-->
      			<?php
										require_once("../../GUI_MG/connessione.php");				$query = "SELECT NOMEGRUPPO, DESCRIZIONE FROM gruppo ";
			...
			echo "<div class='article'><h2><span>Gruppi</span></h2>";
				...
				{	
						 ...
						 <div class='clr'></div>
           				 ...
           				 <p>$row[1] </p>
           				 <div class='clr'></div>
           				  <p class='spec'> <form name='visualizzagruppo.$row[0]' method='post' action='GUIVisualizzaGruppo.php'>
