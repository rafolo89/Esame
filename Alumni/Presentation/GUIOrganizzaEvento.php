     ...
     <div class="sidebar" style="right: 50px; top: -14px" ><!--Pannello laterale, inerente allo specifico utente loggato ed alle sue funzionalità  -->
      ...
      <div class="mainbar" ><!--Pannello della funzionalità principale-->
        <div class="article">
          ...
          <h2>Organizza Evento</h2>
          <div class="clr"></div><p class="infopost">Evento</p>
       
          <div class="post_content">
            <form  method="post" action="GUIOrganizzaEvento.php">
		   <table>
				<tr>
					<td style="height: 37px; width: 103px;">ID Evento</td>
					<td style="height: 37px; width: 224px;"><input type="text" name="idevento" size="35" maxlength="40" value="" required autofocus /></td><td id="tdidleader" style=" color:red; height: 37px"></td>
				</tr>
				<tr>
					<td style="height: 37px; width: 103px;">Nome Evento</td>
					<td style="height: 37px; width: 224px;"><input type="text" name="nomeevento" size="35" maxlength="40" value="" required autofocus /></td><td id="tdnomeevento" style=" color:red; height: 37px"></td>
				</tr>		
				<tr>
					<td style="height: 37px; width: 103px;">Data inizio:</td>
					<td style="height: 37px; width: 224px;"><input type="text" name="datainizio" size="35" maxlength="40" value="" required autofocus /></td><td id="tddata" style=" color:red; height: 37px"></td>
				</tr>
					<tr>
					<td style="height: 37px; width: 103px;">&nbsp;</td>
					<td style="height: 37px; width: 224px;"><br>Descrizione: <br><br>
					<input type="text" name="descrizione" size="35"  maxlength="200" value="" required autofocus style="height: 318px; width: 504px" ></td><td id="tddescrizione" style=" color:red; height: 37px"></td>
				</tr>
				
			<tr>
			<td colspan="3" class="style11">
			<input type="submit"  id="submit" value="Inserisci evento" style="width: 192px"></td>
			</tr>		
