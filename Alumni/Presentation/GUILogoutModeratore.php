...
<a name="s"></a>
 <div class="menu_nav" style="width: 100%;"><!--Menu principale con i collegamenti alle varie pagine/funzionalità del sito-->
  ...
  <div class="content"><!--Contenitore principale delle funzionalità della pagina corrente-->
    <div class="content_resize" style="width: 989px; position:relative; left:156px; top: 0px;">
    

      <!--Pannello della funzionalità principale, ovvero la notifica dell'avvenuto logout -->
      <div class="mainbar" style="margin-left: 418;" >
        <div class="article">
          <h2>Logout del Moderatore</h2>
          <div class="clr"></div>
          <div class="post_content">
            <p>effettuato con successo</p>
          </div>
          <div class="clr"></div>
        </div>
