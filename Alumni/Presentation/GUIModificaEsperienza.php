	...
	<div id='mod95'></div>
      <div class="mainbar" ><!--Pannello della funzionalità principale-->
        <div class="article">
          ...
          <form action = "GUIModificaEsperienza.php#s" method="post">

            <p>
			<textarea  name="testo" cols="70" style="height: 270px"><?php echo $row[0]; ?></textarea></p>
          
           	<input type="submit" id="submit"  value="Modifica Esperienza" style="width: 245px" />
          </form> </div>
<div class="clr"></div>
        </div>
