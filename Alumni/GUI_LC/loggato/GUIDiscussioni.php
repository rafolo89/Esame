     ...
     <div class="mainbar" ><!--Pannello della funzionalità principale-->
      ...
      switch($accacche){
          ...
          <div class='post_content'>
         	 <h3>
         	 <form name='DG' method='post' action='GUIDiscussioni.php'>
          ...
          <div class='post_content'>
          	 <h3>
         	 <form name='OL' method='post' action='GUIDiscussioni.php'>
		  ...
		  <div class='post_content'>
          	 <h3>
         	 <form name='CO' method='post' action='GUIDiscussioni.php'>
		  ...
		  <div class='post_content'>
          	 <h3>
         	 <form name='SB' method='post' action='GUIDiscussioni.php'>
		  ...
		  <div class='post_content'>
          	 <h3>
         	 <form name='EI' method='post' action='GUIDiscussioni.php'>
		  ...
		  <div class='post_content'>
          	 <h3>
         	 <form name='PS' method='post' action='GUIDiscussioni.php'>
		  ...
		  <div class='post_content'>
          	 <h3>
         	 <form name='PP' method='post' action='GUIDiscussioni.php'>
          ...
          <div class='post_content'>
         	 <h3>
         	 <form name='livello.$row[3]' method='post' action='GUIDiscussione.php'>
