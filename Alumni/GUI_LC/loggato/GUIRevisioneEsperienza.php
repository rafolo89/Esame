  ...
  <div class="content"><!--Contenitore principale delle funzionalità della pagina corrente-->
    <div class="content_resize" style="width: 1301px; ">
      ...
      <div class="sidebar" style="right: 50px; top: -14px" ><!--Pannello laterale, inerente allo specifico utente loggato ed alle sue funzionalità  -->
        ...
        <img src="../../images/userpic.gif" alt="BO"  height="100" width="100" style = "float : left"></img><br />
          <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          <?php  			
          ...
          <ul class="sb_menu">
            <li>
   			 	<a href="../../GUI_AO/GUILogoutModeratore.html#s">Logout</a><!--Funzionalità di logout-->
				</li>
				</ul>
          ...
          <ul class="sb_menu">
           ...
           <li>
   			 	<a href="GUIRevisioneEsperienza.php#s"><span class="style10"><strong>
				Revisiona esperienza</strong></span></a>
				</li>
        ...
        <div class="article">
          ...
          <div class="post_content">
			...
			while($row = mysql_fetch_array($q1, MYSQL_NUM)){
            	...
            	echo "<form method='post' action='GUIRevisioneEsperienza.php'>
            	...
            	<td><form method='post' action='GUIRevisioneEsperienza.php'>
            	<input type='hidden' name='valore' value='".$row[0]."' />
