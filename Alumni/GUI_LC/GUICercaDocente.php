...
<br />
      ...
      <div class="mainbar" ><!--Pannello della funzionalità principale-->
        <div class="article">
          ...
          <h2>Cerca docente</h2>
          <div class="clr"></div><p class="infopost">Immettere codice fiscale</p>
          <div class="clr"></div>

          <div class="post_content">
            <form  method="post" action="GUICercaDocente.php">
			<table border="0" cellspacing="5" cellpadding="5">
			<tr>
			<td>Codice fiscale:</td><td><input type="text" name="codicefiscale" size="35" maxlength="40" value="" required autofocus ></td><td id="cf" style=" color:red; height: 37px"></td>
 			<?php 
 			if(isset($_POST['docente'])){
        $cosa=$_POST['docente'];
